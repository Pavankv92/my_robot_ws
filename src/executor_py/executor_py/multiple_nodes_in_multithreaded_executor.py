...
class Node1(Node):
    def __init__(self):
        ...
        self._callback_group_2 = MutuallyExclusiveCallbackGroup()
        # one group
        ...
        self._timer = self.create_timer(1.0, self._callback_timer_3, callback_group=self._callback_group_2) # this will be never called
...
class Node2(Node):
    def __init__(self):
        ...
        self._callback_group_3 = ReentrantCallbackGroup()

        self._timer = self.create_timer(1.0, self._callback_timer_4, callback_group=self._callback_group_3)
        self._timer = self.create_timer(1.0, self._callback_timer_5, callback_group=self._callback_group_3)
        self._timer = self.create_timer(1.0, self._callback_timer_6, callback_group=self._callback_group_3)
